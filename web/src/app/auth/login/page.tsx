...
import { Brain, Mail, Lock, Eye, EyeOff, CreditCard, TrendingUp, Shield } from 'lucide-react';
        ...
        >
          <div className="space-y-8">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gradient">AnkismaikT AI</h1>
                <p className="text-muted-foreground">Investment Bank</p>
              </div>
            </div>
              ...
              <div className="grid gap-4">
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-profit/10 rounded-lg flex items-center justify-center">
                    <CreditCard className="w-5 h-5 text-profit" />
                  </div>
                  <div>
                    <h3 className="font-semibold">Smart Debt Management</h3>
                    <p className="text-sm text-muted-foreground">AI-powered debt repayment strategies</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold">Profit Skimming</h3>
                    <p className="text-sm text-muted-foreground">Automatically secure profits while staying invested</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Your financial data is protected with enterprise security</p>
                  </div>
                </div>
              </div>
            </div>
